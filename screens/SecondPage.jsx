  ...
  return (
    <BottomSheetModalProvider>
      ...
      <TouchableOpacity
        ...
        <View style={{borderRadius:50,width:45,height:45, backgroundColor:'#FF66CC', alignItems:'center', justifyContent:'center'}}>
...
function BottomSheetContent({activeMarker}) {
  ...
  return <ScrollView horizontal={false} showsHorizontalScrollIndicator={false}>
    ...
    <Text style={{marginBottom:5, marginTop:5, }}><B>ที่อยู่ :</B> {activeMarker.address}</Text>
    <Text style={{marginBottom:5, marginTop:5, }}><B>เวลาเปิด :</B> {activeMarker.timeopen}</Text>
    <Text style={{marginBottom:5, marginTop:5, }}><B>เวลาปิด :</B> {activeMarker.timeclose}</Text>
    <Text style={{marginBottom:5, marginTop:5, }}><B>เบอร์โทร :</B> {activeMarker.phone}</Text>
    </View>
    ...
    <TouchableOpacity style={{
      ...
      <View >
      <Text style={{textAlign: "center",fontSize:18,fontWeight:'600' }}>เส้นทาง</Text>
      </View>
    </TouchableOpacity>
  </View>
  </ScrollView>
