      ...
      screenOptions={({ route }) => ({
        tabBarIcon: ({ focused, color, size }) => {
          ...
          if (route.name === "Home") {
            ...
            iconName = focused ? "chatbubble-ellipses" : "chatbubble-ellipses-outline"; // Assuming you have an appropriate icon for the Shipping menu
          } else if (route.name === "Account") {
            iconName = focused ? "person-circle" : "person-circle-outline"; // Assuming you have an appropriate icon for the Shipping menu
          }
